<!-- <template>
  <div class="reader">
    ...
    <div class="menu" v-show='menuShow' @click='menu'>
      <div class="header">
      ...
      <div class="footer">
        <div class="footerSize">
          <span @click="addTextAlign()">Aa-</span>
          <span>Aa+</span>
        </div>
        ...
        <div class="footerContent">
          <p @click.stop='prev'>上一章</p>
          <p @click.stop='content'>目录</p>
          <p @click.stop='next'>下一章</p>
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      getData(){
        ...
        let url = `/juhe/chapters/${encodeURIComponent(this.currentChapter.link)}`
        axios(url).then((res)=>{
      ...
      addTextAlign(){
        let   a=  parseInt(this.changeFontSize)
        console.log(this.changeFontSize);
        // a-=2
        // this.changeFontSize=`${a}px`
      },
      loadMore(){
        if(!this.list[0]){
          return
    ...
    //   this.getData()
    // },
      ...mapMutations(['changeChapterIndex','changeShow','changeFontSize'])
    },
    watch:{
      currentShow(val){
        this.list = []
...
<template>
  ...
  <div class="menu" @click='menu'>
    <transition name='header'>
      <div class="header" v-show='menuShow' :style='{background:neight? "rgba(0,0,0,0.9)":"rgba(50,148,150,0.9)"}'>
    ...
    <transition name='footer'>
      <div class="footer"  v-show='menuShow' :style='{background:neight? "rgba(0,0,0,0.9)":"rgba(50,148,150,0.9)"}'>
        <div class="font">
